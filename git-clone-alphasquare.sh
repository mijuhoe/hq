...
git clone ssh://git@gitlab.com/m8228308850/alphasquare_downloader_us
git clone ssh://git@gitlab.com/m8228308850/alphasquare_downloader_crypto
git clone ssh://git@gitlab.com/m8228308850/alphasquare_downloader_upbit
git clone ssh://git@gitlab.com/m8228308850/alphasquare_downloader_240m
git clone ssh://git@gitlab.com/m8228308850/alphasquare_downloader_120m
